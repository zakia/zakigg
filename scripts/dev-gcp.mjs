...
try {
	...
	const devEnv = {
		...
		AUTH_ALLOWED_EMAIL: cloudEnv.AUTH_ALLOWED_EMAIL,
		GITHUB_CLIENT_ID: cloudEnv.GITHUB_CLIENT_ID,
		GITHUB_INSTALLATION_ID: cloudEnv.GITHUB_INSTALLATION_ID,
		GITHUB_OWNER: cloudEnv.GITHUB_OWNER,
		GITHUB_REPO: cloudEnv.GITHUB_REPO,
		GITHUB_BRANCH: cloudEnv.GITHUB_BRANCH,

...
import type { ComponentEmbedRegistry } from '../core/embeds';
...
export function parseEditorMarkdown(markdown: string, embeds: ComponentEmbedRegistry) {
	...
	const editor = new Editor({
		extensions: createEditorExtensions(embeds).filter(
...
// paragraph. Shared by paste and the document importer, which manage metadata
